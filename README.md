...
`cordova create AADGraphSample`

`cd AADGraphSample`

Then copy content of the sample from `active-directory-cordova-graphapi/AADGraphClient` folder to `www` subfolder of the Cordova application using file manager or the following command in your shell:
